...
The launcher does not contain the mod package and does not download files from Nexus Mods. Users must manually download the official mod archive themselves before selecting it for installation.
